 ...
 * - Cleanup ASN.1 code, possibly replace with own impl
 * - ...
 * 
 * References:
 * 
...
public final class EcCore extends Provider {
	...
	private static final ECParameterSpec P224 = new ECParameterSpec(
			new EllipticCurve(
					new ECFieldFp(new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001", 16)), 
	...
	private static BigInteger[] doublePointJ(BigInteger[] P, ECParameterSpec params) {
		...
		return new BigInteger[] {
				D,
				C.multiply( A.subtract(D) ).subtract(B).mod(p),
				TWO.multiply(P[1]).multiply(P[2]).mod(p)
		};
	}
	
	private static BigInteger[] addPointsJA(BigInteger[] P1, BigInteger[] P2, ECParameterSpec params) {
		final BigInteger p = ((ECFieldFp)params.getCurve().getField()).getP();
		BigInteger A, B, C, D;
		BigInteger X3;
...
//		// </DEBUG>
	...
	static BigInteger[] multiplyPoints(BigInteger[] P, BigInteger k, BigInteger[] Q, BigInteger l, ECParameterSpec params) {
...
//	}
	...
	public static void main(String[] args) throws Exception {
		...
		//	  Private value: a9231e0d113abdacd3bb5edb24124fbef6f562c5f90b835670f5e48f775019f2
		//	  Parameters: P-256 (1.2.840.10045.3.1.7)
		//	GooKey EC public key, 256 bit
		//	  Public value (x coordinate): 86645e0320c0f9dc1a9b8456396cc105754df67a9829c21e13ab6ecf944cf68c
		//	  Public value (y coordinate): ea1721a578043d48f12738359b5eb5f0dac2242ec6128ee0ab6ff40c8fe0cae6
		//	  Parameters: P-256 (1.2.840.10045.3.1.7)
		//	GooKey EC private key, 256 bit
		//	  Private value: b84d5cfab214fc3928864abb85f668a85b1006ca0147c78f22deb1dcc7e4a022
		//	  Parameters: P-256 (1.2.840.10045.3.1.7)
		//	GooKey EC public key, 256 bit
		//	  Public value (x coordinate): 61f6f7264f0a19f0debcca3efd079667a0112cc0b8be07a815b4c375e96ad3d1
		//	  Public value (y coordinate): 3308c0016d776ed5aa9f021e43348b2e684b3b7a0f25dc9e4c8670b5d87cb705
		//	  Parameters: P-256 (1.2.840.10045.3.1.7)		
		
		// P = kG
		BigInteger k = new BigInteger("a9231e0d113abdacd3bb5edb24124fbef6f562c5f90b835670f5e48f775019f2", 16);
		...
		// Q = lG
		BigInteger l = new BigInteger("b84d5cfab214fc3928864abb85f668a85b1006ca0147c78f22deb1dcc7e4a022", 16);
		...
		for (int s = 0; s < ecdsas.length; s++) {		
			...
			for (int i = 0; i < keyLengths.length; i++) {
				...
				for (int n = 0; n < iter; n++) {
					...
					ECPrivateKeySpec ecPrivSpec = new ECPrivateKeySpec(ecPrivKey.getS(), ecPrivKey.getParams());
					...
					if (nssProv != null) { 
						...
						ECPrivateKey nssPrivKey = (ECPrivateKey)keyFab.generatePrivate(new PKCS8EncodedKeySpec(ecPrivKey.getEncoded()));
						ECPublicKey nssPubKey = (ECPublicKey)keyFab.generatePublic(new X509EncodedKeySpec(ecPubKey.getEncoded()));
