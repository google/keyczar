...
/**
 * Tests performance of AES and HMAC in keyczar.
 * 
...
public class SymmetricPerformanceTest {
  ...
  private static void displayPerformance(long start, long end, int size, int trials) {
  ...
  public static void main(String[] args) throws KeyczarException, InterruptedException {
