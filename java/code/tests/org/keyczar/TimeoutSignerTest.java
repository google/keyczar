...
/**
 * Tests Signer class for signing and verifying timeout signatures with HMAC, RSA, and DSA.
 *
...
public class TimeoutSignerTest extends TestCase {
  ...
  private final void testTimeoutSignAndVerify(TimeoutSigner signer) throws KeyczarException {
