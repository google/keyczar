...
public class UriSignerTest extends TestCase {
  String[] testUris = {"www.foo.com", "http://www.foo.com/bar#foo", "http://foo.com/q?a=1&b=2&c=3",
      "http://foo.com/q?c=3&b=2&a=1", "http://foo.com/q?c=3&b=2&a=1#blah"};
  UriSigner uriSigner;
  ...
  @Test
  public final void testSignAndVerifyUri() throws KeyczarException, URISyntaxException {
  ...
  /**
   * Tests that the signatures on two URIs with the same canonical representation are indeed the
   * same.
   *
   ...
   */
  @Test
  public final void testCanonicalUri() throws KeyczarException, URISyntaxException {
