...
/**
 * Tests signed session encryption and decryption with RSA, DSA and AES.
 *
...
public class SignedSessionTest extends TestCase {
  ...
  public final void testWrongSession() throws KeyczarException {
    ...
    sessionDecrypter = new SignedSessionDecrypter(
        privateKeyDecrypter, publicKeyVerifier, newSessionMaterialString);
    try {
