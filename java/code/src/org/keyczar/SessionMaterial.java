...
/**
 * Data used for session based encryption. This consists of the AES key used to encrypt the
 * plaintext and the nonce used for signing.
 *
 *  The nonce should be Base64 encoded prior to being added to the session material.
 *
