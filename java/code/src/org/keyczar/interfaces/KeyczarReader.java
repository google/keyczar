...
/**
 * Abstract class for KeyczarReaders. Typically, these will read key files from disk, but may be
 * implemented to read from arbitrary sources.
 *
...
public interface KeyczarReader {
   ...
   * @throws KeyczarException If an error occurs while attempting to read data, e.g. an IOException
   */
   ...
   * @throws KeyczarException If a primary key is not found or a load error occurs.
   */
