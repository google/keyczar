...
/**
 * A SessionDecrypter will be instantiated with session material containing an encrypted symmetric
 * key. That key will be decrypted with the given {@link Crypter} and used to instantiate another
 * {@link Crypter}.
 *
 * This class and {@link SessionEncrypter} have been deprecated in favor of {@link SessionCrypter}.
 *
...
public class SessionDecrypter {
   ...
   */
  public SessionDecrypter(Crypter crypter, byte[] sessionMaterial) throws KeyczarException {
