...
/**
 * TimeoutVerifiers verify timeout signatures generated by {@link org.keyczar.TimeoutSigner} objects
 *
...
public class TimeoutVerifier {
  ...
  /**
   * Initialize a new TimeoutVerifier with a KeyczarReader. The corresponding key set must have a
   * purpose {@link org.keyczar.enums.KeyPurpose#VERIFY}.
   *
  ...
  /**
   * Initialize a new TimeoutVerifier with a key set location. This will attempt to read the keys
   ...
   * @return A boolean value indicating whether the timeout signature verified. This will be false
  ...
  public boolean verify(ByteBuffer data, ByteBuffer timeoutSignature) throws KeyczarException {
    ...
    ByteBuffer prependedData = ByteBuffer.allocate(Signer.TIMESTAMP_SIZE + data.remaining());
