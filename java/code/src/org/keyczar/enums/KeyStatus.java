 ...
 * <ul>
 *   <li>Primary: This key can verify or decrypt existing data and can sign or encrypt new data.
 *   <li>Active: This key can only verify or decrypt existing data.
 *   <li>Inactive: This key can only verify or decrypt existing data and may be revoked at any time.
 * </ul>
 *
 * <p>
