...
/**
 * UnversionedSigners may both sign and verify data using sets of symmetric or private keys. Sets of
 * public keys may only be used with {@link Verifier} objects.
 *
 *  UnversionedSigners do not include any key versioning in their outputs. They will return standard
 * signatures (i.e. HMAC-SHA1, RSA-SHA1, DSA-SHA1).
 *
...
public class UnversionedSigner extends UnversionedVerifier {
  ...
  /**
   * Initialize a new UnversionedSigner with a KeyczarReader. The corresponding key set must have a
  ...
  /**
   * Initialize a new UnversionedSigner with a key set location. This will attempt to read the keys
   ...
   * @throws KeyczarException If this UnversionedSigner does not have a primary or a JCE exception
   *         occurs.
   */
