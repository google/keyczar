...
/**
 * A session encrypter will generate and encrypt a session key with a given {@link Encrypter}. That
 * session key will be used to encrypt arbitrary data.
 *
 * This class and {@link SessionDecrypter} have been deprecated in favor of {@link SessionCrypter}.
 *
...
public class SessionEncrypter {
  ...
  /**
   * Create a session encrypter. This will generate a session key and encrypt it with the given
   * Encrypter. That session key will be used to encrypt arbitrary data.
   *
